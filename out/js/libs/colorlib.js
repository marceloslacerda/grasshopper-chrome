...
const ColorLib = function () {
  ...
  let factory = function () {
    ...
    instance.get_rgb_distance = function (a, b) {
      return Math.sqrt(((a[0] - b[0]) * (a[0] - b[0]) + (a[1] - b[1]) * (a[1] - b[1]) + (a[2] - b[2]) * (a[2] - b[2])) / (256 * Math.sqrt(3)));
    };
    instance.get_rgba_distance = function (a, b) {
      return Math.sqrt(((a[0] - b[0]) * (a[0] - b[0]) + (a[1] - b[1]) * (a[1] - b[1]) + (a[2] - b[2]) * (a[2] - b[2]) + (a[3] - b[3]) * (a[3] - b[3])) / (256 * Math.sqrt(4)));
    };
    instance.get_dark_color = function () {
      let n = 55;
      return instance.rgb_to_hex([get_random_int(0, n), get_random_int(0, n), get_random_int(0, n)]);
    };
    instance.get_light_color = function () {
      let n = 55;
      return instance.rgb_to_hex([255 - get_random_int(0, n), 255 - get_random_int(0, n), 255 - get_random_int(0, n)]);
    };
    return instance;
  };
  return factory;
