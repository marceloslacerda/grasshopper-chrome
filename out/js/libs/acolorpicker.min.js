  ...
  return function (e) {
    ...
    function m(e) {
      var t = e.getContext("2d"),
        r = +e.width,
        i = +e.height,
        n = t.createLinearGradient(1, 1, 1, i - 1);
        ...
        return i(e, [{
          ...
          value: function (e, t) {
            ...
            switch (e) {
              ...
              case "S":
                this.S = t;
                var a = (0, s.hslToRgb)(this.H, this.S, this.L),
                  l = o(a, 3);
              ...
              case "L":
                this.L = t;
                var c = (0, s.hslToRgb)(this.H, this.S, this.L),
                  h = o(c, 3);
              ...
              case "G":
                this.G = t;
                var d = (0, s.rgbToHsl)(this.R, this.G, this.B),
                  v = o(d, 3);
              ...
              case "B":
                this.B = t;
                var m = (0, s.rgbToHsl)(this.R, this.G, this.B),
                  A = o(m, 3);
              ...
              case "RGB":
                ...
                var k = (0, s.rgbToHsl)(this.R, this.G, this.B),
                  F = o(k, 3);
              ...
              case g:
                ...
                var B = (0, s.rgbToHsl)(this.R, this.G, this.B),
                  H = o(B, 3);
              ...
              case b:
                ...
                break;
              case "RGBHEX":
                var L = (0, s.cssColorToRgba)(t) || [this.R, this.G, this.B, this.A],
                  w = o(L, 4);
                this.R = w[0], this.G = w[1], this.B = w[2], this.A = w[3];
                var T = (0, s.rgbToHsl)(this.R, this.G, this.B),
                  x = o(T, 3);
                ...
                break;
              case f:
                var G = (0, s.parseColor)(t, "rgba") || [0, 0, 0, 1],
                  I = o(G, 4);
          ...
          key: "updatePointerSL",
          value: function (e, t, r) {
            var i = (0, s.hslToRgb)(e, t, r),
              n = o(i, 3),
              a = n[0],
              l = n[1],
              c = n[2],
              h = this.slBarHelper.findColor(a, l, c),
              u = o(h, 2),
              p = u[0],
              d = u[1];
    ...
    function h(e, t, r) {
      var i = void 0,
        o = void 0,
        s = void 0,
        n = [a(e, 0, 360) / 360, a(t, 0, 100) / 100, a(r, 0, 100) / 100];
